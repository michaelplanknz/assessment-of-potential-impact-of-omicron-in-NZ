function [nInfected, nIsol, cases_0dose, cases_1dose, cases_2dose, cases_3dose, nHosp, dailyHosp_0dose, dailyHosp_1dose, dailyHosp_2dose, dailyHosp_3dose, nDisc, nICUIn, nICUOut, nDeaths] = postProcess(cases, par)
...
cases_2dose = histcounts2(cases.tIsol(cases.vaccDoses == 2 | cases.vaccDoses == 3 | cases.vaccDoses == 4 | cases.vaccDoses == 5), ...
    cases.ageGroup(cases.vaccDoses == 2 | cases.vaccDoses == 3 | cases.vaccDoses == 4 | cases.vaccDoses == 5), tExt, 1:par.nAgeGroups+1);
cases_3dose = histcounts2(cases.tIsol(cases.vaccDoses == 6 | cases.vaccDoses == 7 | cases.vaccDoses == 8 | cases.vaccDoses == 9), ...
    cases.ageGroup(cases.vaccDoses == 6 | cases.vaccDoses == 7 | cases.vaccDoses == 8 | cases.vaccDoses == 9), tExt, 1:par.nAgeGroups+1);
...
dailyHosp_2dose = histcounts2(cases.tHosp(cases.vaccDoses == 2 | cases.vaccDoses == 3 | cases.vaccDoses == 4 | cases.vaccDoses == 5), ...
    cases.ageGroup(cases.vaccDoses == 2 | cases.vaccDoses == 3 | cases.vaccDoses == 4 | cases.vaccDoses == 5), tExt, 1:par.nAgeGroups+1);
dailyHosp_3dose = histcounts2(cases.tHosp(cases.vaccDoses == 6 | cases.vaccDoses == 7 | cases.vaccDoses == 8 | cases.vaccDoses == 9), ...
    cases.ageGroup(cases.vaccDoses == 6 | cases.vaccDoses == 7 | cases.vaccDoses == 8 | cases.vaccDoses == 9), tExt, 1:par.nAgeGroups+1);
